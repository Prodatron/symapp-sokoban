...
WRITE "e:\symbos\apps\sokoban.exe"
...
prgmemtab   db "SymExe10"           ;SymbOS-EXE-identifier              POST table reserved memory areas
            dw mapbuf_size+5        ;additional code memory (for loaded maps)
            dw 0                    ;additional data memory
            dw 0                    ;additional transfer memory
            ds 26                   ;*reserved*
            db 1,2                  ;required OS version (2.1)
prgicnsml   db 2,8,8,#77,#EE,#F8,#F1,#FB,#DF,#EB,#5F,#EB,#DF,#FB,#DF,#8F,#1F,#77,#EE
prgicnbig   db 6,24,24
            db #0F,#DD,#8F,#0F,#0F,#6E,#FF,#5D,#7F,#FF,#FF,#AE,#FF,#88,#FF,#FF,#FF,#CC,#00,#00,#00,#00,#00,#00,#FF,#EE,#00,#70,#80,#00,#FF,#FD,#40,#F7,#C8,#00,#F0,#F3,#30,#FF,#EC,#00,#FF,#BF,#10,#F0,#FE,#00
            db #FF,#BF,#00,#0F,#F6,#00,#7F,#BF,#01,#4B,#7A,#00,#3F,#BF,#09,#4B,#7A,#00,#1F,#BF,#0C,#0F,#E0,#00,#0F,#BF,#3D,#FF,#FE,#00,#1F,#BF,#35,#FF,#FF,#80,#3F,#BF,#00,#73,#FF,#C8,#7F,#BF,#00,#73,#FF,#C8
            db #FF,#BF,#00,#73,#FF,#C8,#0F,#3F,#00,#31,#F8,#A4,#FF,#DF,#00,#03,#80,#2C,#FF,#EE,#00,#70,#10,#C0,#00,#00,#00,#00,#00,#00,#FF,#88,#FF,#FF,#FF,#CC,#FF,#D5,#F7,#FF,#FF,#EA,#F0,#DD,#F8,#F0,#F0,#E6
